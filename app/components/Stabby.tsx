...
const StabbySVG = (props: SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" {...props}>
    <defs>
      <clipPath id="a">
        <path
          d="M34.481-16.239 54.924-.982a1.503 1.503 0 0 0 2.391-1.022 1.493 1.493 0 0 0-.593-1.377L51.511-7.27l2.999-4-4.672-3.486 2.596-.373a.997.997 0 0 0 .644-1.606 1.001 1.001 0 0 0-.929-.371l-3.964.569a1 1 0 0 1-.401-1.953l.115-.023.991-.143a.998.998 0 1 0-.285-1.977l-8.706 1.252a7.976 7.976 0 0 0-5.266 2.945l-.152.197Zm3.075-.199.102-.066a6.016 6.016 0 0 1 2.011-.816l.303-.054.119-.019a6.007 6.007 0 0 1 4.192.993l.208.149 7.214 5.384-2.397 3.199-11.752-8.77Z"
          transform="rotate(135.291 45.903 -10.662)"
        />
      </clipPath>
    </defs>
    ...
    <path
      ...
      // bx:shape="triangle 34.05 -14.935 24.163 14.204 1 0 1@9d142a7e"
    />
  </svg>
);
